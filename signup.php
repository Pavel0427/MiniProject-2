        ...
        <div class="row">
            <center class="flex items-center justify-center mt-8">
                ...
                <div class="inline-block box-content bg-white h-96 w-3/6 rounded-xl bg-opacity-90  drop-shadow-md rounded-tl-none rounded-bl-none">
                    <div class="flex flex-row px-12 pt-12 text-2xl font-bold text-indigo-500   drop-shadow-sm">
                        <h2 class="ml-4 "><a href="signup.php">Sign Up</a> </h2>
                        <h2 class="ml-4  text-indigo-200 "><a href="login.php">Log In</a> </h2>
                        <div class="absolute left-16 top-20 mt-2 ml-1 flex h-1 w-20 bg-sky-300"></div>
                    </div>
                ...
                <input type="tel" name="contact" id="name"> -->
                            ...
                            <input class="bg-slate-200 bg-opacity-50 rounded-sm" type="text" name="pass" id="pass">
                             ...
                             <input id="signup_button" type="button" value="Sign Up" class="bg-gradient-to-tl from-sky-300 to-indigo-400 text-md font-semibold rounded-lg px-2 py-1 text-white"> 
                ...
                <input type="text" name="passcon" id="name"> -->
                        ...
                        <br>
                        <span>Already have an Account? <a href="login.php" class="text-indigo-500">Login </a> here</span>
                    </div>
